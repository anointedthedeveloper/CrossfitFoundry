...
const SAMPLE_EVENT_DATA = [
  {
    ...
    description: 'Annual in-house CrossFit competition. Athletes of all skill levels are welcome. Scaled and RX divisions. Prize podium, judges panel, and spectator zone fully set up.',
  ...
  },
  {
    ...
    description: 'Bring a friend for free. Guided intro WOD, tour of the facility, and a Q&A with our head coaches. No experience necessary.',
    category: 'FREE TRIAL',
